  ...
  return (
    <div className="mt-20">
      ...
      <div className="text-center mb-10">
        <h3 className="text-gray-500 tracking-[4px] uppercase text-sm">
          Introduction
        </h3>
      ...
      <div className="w-[90%] md:w-[75%] mx-auto flex flex-col md:flex-row gap-14 items-center">
        ...
        <div className="w-full md:w-1/2 font-mono space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="p-5 rounded-2xl border bg-white hover:-translate-y-1 hover:shadow-xl transition duration-300">
              <RiCodeSSlashLine size={24} />
              <h2 className="font-bold mt-3">Languages</h2>
              <p className="text-sm text-gray-600 mt-1">HTML, CSS, JS, React</p>
            </div>
            ...
            <div className="border rounded-2xl p-5  transition duration-300 hover:-translate-y-4 hover:shadow-6xl hover:border-r-amber-400">
              ...
              <p className="text-sm text-gray-600 mt-1">5+ Built Projects</p>
            </div>
          ...
          {/* Tools */}
          <div>
            <h3 className="text-sm text-gray-500 mb-3">Tools I Use</h3>
